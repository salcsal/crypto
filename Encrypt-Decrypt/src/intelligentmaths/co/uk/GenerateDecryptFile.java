...
public class GenerateDecryptFile {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println("Going to decrypt the encrypted portion of the file.");

			fileHandler.doDecrypt(key, afterSelectedTextEncryptedFile, textBeforeDecryption, decryptedFile);

			System.out.println("Generated file after decryption. Please check.");
