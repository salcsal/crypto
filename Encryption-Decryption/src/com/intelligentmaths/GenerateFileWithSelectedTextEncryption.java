...
public class GenerateFileWithSelectedTextEncryption {
	...
	public static void main(String[] args) {
		...
		try {
			System.out
					.println("Going to Encrypt sensitive information in the file.");

			fileHandler.doEncrypt(key, normalFile, textBeforeEncryption,
					afterSelectedTextEncryptedFile);

			System.out
					.println("Generated File after encrypting sensitive information. Please check.");
